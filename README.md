...
3. In the **journey** module, there is a `journeyMaker()` function. In that function, there is a variable named `areas` which will have the value of an object. Use your debugger to show what the value of each key is on that object. Use [Loom](https://www.loom.com) to record your session. https://www.loom.com/share/68fa48585fad4c4f84b1f8b2e26cde3f also I have the whole seasion recorded here are the other two links https://www.loom.com/share/937d2c647ed24510af5d1a51db3ed386?t=17  https://www.loom.com/share/b0569f10ab91413eaa79cf9b82e67c17
...
4. Also in the **journey** module, there is the following code:
   ...
   > Your answer here. So we are using a for loop and in the for loop we have a function using the let var and its name is forestNumber and its value is set to 0. then we are passing an arguement saying if forest is less than ares.forest, and we also have it adding 1 to forest. The last thing it is doing is pushing the data to the journey array.
5. Explain the value of the `database` variable in the **database** module. Be as comprehensive as possible.
   > Your answer here. Database is an array that is holding two other arrays called drovers and cattleType both these are object arrays.
6. In the **drovers** module, there is a `hireDrovers()` function. You will notice the following code on that line - `(herdSize)`. What is that defining, and where does it get its value?
   > Your answer here. herdSize is a place holder(argument) so whenever the function gets called thats when it gets its value so when it is run the value should be 50.
