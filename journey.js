...
const createRivers = () => {
    const rivers = Math.floor(Math.random()) + 1
    return rivers
}

const createMountains = () => {
    const mountains = Math.floor(Math.random()) + 1
    return mountains
}

const createForests = () => {
    const forests = Math.floor(Math.random()) + 1
    return forests
}

const createPlains = () => {
    const plains = Math.floor(Math.random()) + 1
    return plains
}
